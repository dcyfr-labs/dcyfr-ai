...
echo "   - Go to: https://github.com/dcyfr-labs/dcyfr-ai/settings/secrets/actions"
...
echo "   https://github.com/dcyfr-labs/dcyfr-ai/pulls"
echo ""
...
echo "   https://github.com/dcyfr-labs/dcyfr-ai/actions"
echo ""
